...
Lo siguiente que necesitaremos será [`esto`](https://xdaforums.com/attachments/amonet-cronos-v1-1-2-zip.6325109/). Con lo cual se nos descargará un .zip que al descomprimirlo, dentro de `amonet-cronos-v1.1.2/amonet/` tendremos todos los scripts necesarios:
