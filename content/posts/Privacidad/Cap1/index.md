---
author: Tensae
title: La privacidad en internet
date: 2026-04-01
description: Opinión sobre la privacidad en internet. Primero capitulo de la serie
categorías: [opinión]
...
Esto **no tiene porque ser hecho por cibercriminales**, sino también por empresas (Como podeís ver en [`este`](#manipulación-de-masas) apartado de más adelante) o entidades con el fin de sacar benefeficio de nuestra información, eso sí, saltandose la ley.
...
{{< alert icon=comment >}}
Este tema en concreto es tratado más en profundidad en un post de proton [aquí](https://protonvpn.com/blog/surveillance-pricing)
{{< /alert >}}

#### Manipulación de masas
Esto aunque parezca que no nos puede afectar es más probable de lo que parece. 
Resulta que debido a que nuestra dependencia de contenido recae sobre ellos se ven sitiuaciones como: obtención de datos de millones de personas sin consentimiento con el objetivo de orientar contenido para manipular a parte de la sociedad. Caso que se vió en las elecciones de Estados Unidos a través de facebook hace unos años. 
Se puede buscar con el nombre "**El caso de Cambridge Analytics**"
